...
class KidsListPage extends StatefulWidget {
  const KidsListPage({Key? key}) : super(key: key);
...
class _KidsListPageState extends State<KidsListPage> {
  // ApiService methods are static; call them on the class directly.
  ...
  Future<void> _loadKids() async {
    try {
      final kids = await ApiService.getAllKids();
      setState(() {
        _kids = kids;
        _filteredKids = kids;
        _isLoading = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // TODO: Navegar para tela de adicionar aluno
        },
